"""
===============================================================================
SARVAM VISION - Document Intelligence Dashboard (with Image Display)
===============================================================================
"""
...
# ============================================================================
# FUNCTION: Extract and render content (including images)
# ============================================================================

def render_extracted_content(content: str, format_type: str):
    """Render extracted content with proper image handling"""
    
    if format_type == "md":
        # Markdown content - contains base64 images
        # Display the content directly (Streamlit auto-renders markdown)
        st.markdown(content)
        
        # Also show any base64 images that might be embedded
        ...
        if matches:
            ...
            for i, (img_type, img_data) in enumerate(matches):
                try:
                    ...
                    st.image(image_bytes, caption=f"Extracted Image {i+1}", use_column_width=True)
...
if st.button("🚀 Process Document", type="primary", use_container_width=True):
    ...
    try:
        ...
        # Step 9: Extract content from ZIP
        extracted_content = ""
        ...
        with zipfile.ZipFile(output_zip, 'r') as zf:
            for file_name in zf.namelist():
                with zf.open(file_name) as f:
                    ...
                    if (output_format == "md" and file_name.endswith('.md')) or \
                       (output_format == "html" and file_name.endswith('.html')):
        ...
        with result_container:
            ...
            if extracted_content:
                ...
                render_extracted_content(extracted_content, output_format)
                
                # Also show raw text for copying
                with st.expander("🔍 Show Raw Text"):
                    st.code(extracted_content, language="markdown" if output_format == "md" else "html")
                ...
                st.warning("No content was extracted. Check the ZIP file for results.")
                with open(output_zip, "rb") as f:
                    st.download_button(
                        "📦 Download Output ZIP",
                        f.read(),
